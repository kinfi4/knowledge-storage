...
public class Main {
    public static void main(String[] args) {
        ...
        start = Instant.now();
        int[][] C3 = stripeMatrixMultiplication(A, B, 100);
        end = Instant.now();
        timeElapsed = Duration.between(start, end);
        System.out.print("  Stripe multiplication: " + timeElapsed.toMillis());

        start = Instant.now();
        int[][] C2 = foxMatrixMultiplication(A, B, 4);
        end = Instant.now();
        timeElapsed = Duration.between(start, end);
        System.out.println("  FOX multiplication: " + timeElapsed.toMillis());


        System.out.println("Matrix are equal: " + _checkMatrixAreEqual(C, C2));
        System.out.println("Matrix are equal: " + _checkMatrixAreEqual(C, C3));
    }
