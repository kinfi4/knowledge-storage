...
class CustomersWindow:
    def __init__(self) -> None:
        self._mysql_engine = MysqlEngine()
        ...
        self._sqlite_engine = SqliteEngine()
        self._postgres_engine = PostgresEngine()
    ...
    def delete_customer(self):
        ...
        if answer == "yes":
            try:
                ...
                self.error_message(
                    "Something went wrong during customer deleting, in case if error persist please contact support.")
                return
    ...
    def add_product(self):
        ...
        # if everything is filled
            ...
            try:
                ...
                self.error_message(
                    "Something went wrong during product adding, in case if error persist please contact support.")
                return
    ...
    def delete_product(self):
        ...
        if answer == "yes":
            ...
            try:
                ...
                self.error_message(
                    "Something went wrong during product deleting, in case if error persist please contact support.")
                return
    ...
    def update_product(self):
        ...
        # everything is filled finally updating
            ...
            try:
                ...
                self.error_message(
                    "Something went wrong during product updating, in case if error persist please contact support.")
                return
