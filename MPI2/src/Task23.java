...
public class Task23 {
    public static void main(String[] args) {
        ...
        int[] A1D = Task22.convert2DTo1D(A);
        int[] B1D = Task22.convert2DTo1D(B);
        ...
        int[][] blocksA = Task22.convert1DTo2D(bufferA, numberOfItems, matrixSize);
        int[][] blocksB = Task22.convert1DTo2D(bufferB, numberOfItems, matrixSize);
