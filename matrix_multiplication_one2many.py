...
if __name__ == '__main__':
    ...
    A = np.empty((MATRIX_SIZE_1, MATRIX_SIZE_2))
    B = np.empty((MATRIX_SIZE_2, MATRIX_SIZE_3))
    ...
    comm.Gather([product, product.size, MPI.DOUBLE], [C, elements_per_process, MPI.DOUBLE], root=MASTER)
