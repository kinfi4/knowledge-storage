...
<?php
    ...
    if ($orderBy) {
        $getAllBooksQuery = "SELECT book.id, title, publishYear, price, name, authorId, dateAdded FROM book JOIN author ON book.authorId = author.id ORDER BY $orderBy";
    } else {
        $getAllBooksQuery = "SELECT book.id, title, publishYear, price, name, authorId, dateAdded FROM book JOIN author ON book.authorId = author.id";
    }

    $response = mysqli_query($conn, $getAllBooksQuery);

    echo "<a class='addButton' href='stats.php'>Statistics</a>";
    echo "<a class='addButton' href='search.php'>Find books</a>";
    ...
    echo "<table id=\"books\">";
        echo "<tr>";
            ...
            echo "<th><a href='./index.php?orderBy=dateAdded'>Date Added</a></th>";
            echo "<th></th>";
            echo "<th></th>";
        echo "</tr>";
